...
def calcular_ano_ultrapassagem_populacional(
    ...
    if taxa_crescimento_populacao_menor < taxa_crescimento_populacao_maior:
        print(f"'A taxa de crescimento do país B ({100*taxa_crescimento_populacao_maior:.1f}%) deve ser menor do que a do país A ({100*taxa_crescimento_populacao_menor:.1f}%)'")
